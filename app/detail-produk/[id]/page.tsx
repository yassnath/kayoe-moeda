        ...
        <div className="mx-auto w-full max-w-6xl px-4 md:px-6 grid gap-8 lg:grid-cols-[1.1fr,0.9fr] items-start">
          ...
          <div className="rounded-3xl border border-km-line bg-white p-6 md:p-7 shadow-soft space-y-5">
            ...
            <div className="flex flex-col gap-3">
              <Link
                href={`/cart/checkout`}
                className="w-full text-center rounded-full bg-km-brass text-white ring-1 ring-km-brass/70 px-6 py-3 text-sm font-semibold
                           shadow-soft hover:opacity-90 transition no-underline"
              >
                Pesan Sekarang
              </Link>
